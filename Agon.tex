...
Without the weapons that can subdue it,
Through crippling fear the soul will burn and plunge
Into an immense abysm, falling down
Into the mute and uninhabited
Divinity, where no work, no image,
No words and no colours can wear down man.
In the simple foundation, mute desert,
Where no diversity is ever seen.
They are transformed into an assembly
Belched forth from the depths of abysms unknown.
\end{alltt}
